    ...
    <n-modal v-model:show="showModal">
      <n-card style="width: 600px" :title="cardTitle" :bordered="false" size="huge" role="dialog" aria-modal="true">
        <n-form ref="formRef" size="large" :show-label="false">
          <n-space class="w-full pt-16px" :size="10">
            <n-form-item>
              <n-select
            ...
            <n-form-item>
              <n-input v-model:value="valueEditInput[valueSelect]" placeholder="请输入" style="width: 380px" />
            </n-form-item>
          </n-space>
          <n-form-item>
    ...
    render: row => {
      return (
        <NSpace justify={'center'}>
          <NButton type="success" size={'small'} onClick={() => handleEditTable(row.dataId)}>
            编辑
          </NButton>
