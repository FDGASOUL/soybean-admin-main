    ...
    <n-grid-item span="0:24 640:24 1024:4">
      <n-card :bordered="false" class="h-full rounded-16px shadow-sm">
        <n-popover trigger="hover">
          <template #trigger>
            <n-button style="margin-top: 26px; margin-left: 22px">皮尔森相关系数</n-button>
          </template>
          <span>矩相关系数，使用具体数据计算，且消除了量纲的影响，适用于线性关系、正态分布或单峰分布，统计效能高</span>
        </n-popover>
      </n-card>
    </n-grid-item>
    <n-grid-item span="0:24 640:24 1024:4">
      <n-card :bordered="false" class="h-full rounded-16px shadow-sm">
        <n-popover trigger="hover">
          <template #trigger>
            <n-button style="margin-top: 26px; margin-left: 22px">斯皮尔曼相关系数</n-button>
          </template>
          <span>秩相关系数，使用数据等级进行计算，适用数据更广，有更强的鲁棒性</span>
        </n-popover>
      </n-card>
    </n-grid-item>
    <n-grid-item span="0:24 640:24 1024:4">
      <n-card :bordered="false" class="h-full rounded-16px shadow-sm">
        <n-popover trigger="hover">
          <template #trigger>
            <n-button style="margin-top: 26px; margin-left: 22px">肯德尔秩相关系数</n-button>
          </template>
          <span
            >秩相关系数，使用数据等级进行计算，适用数据较广，有多个公式适应多种情况，对非线性数据可能有部分误差</span
          >
        </n-popover>
      </n-card>
    </n-grid-item>
